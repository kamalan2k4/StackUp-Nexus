...
CREATE TABLE "users" (
	...
	CONSTRAINT "users_stackup_id_unique" UNIQUE("stackup_id")
);

ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_user_id_users_id_fk" 
